...
project = u'Sensirion I²C Python Driver'
copyright = u'{} Sensirion AG, Switzerland'.format(datetime.now().year)
author = u'Sensirion AG'


# The short X.Y version
version = sensirion_i2c_driver.__version__
# The full version, including alpha/beta/rc tags
release = sensirion_i2c_driver.__version__
...
htmlhelp_basename = 'PythonDriverforSensirionI2cDevices'
...
latex_documents = [
    (
        master_doc,
        'PythonDriverforSensirionI2cDevices.tex',
        u'Python Driver for I²C Devices Documentation',
        u'Sensirion AG',
        'manual'
    ),
]
...
man_pages = [
    (
        master_doc,
        'pythondriverforsensirioni2cdevices',
        u'Python Driver for I²C Devices Documentation',
        [author],
        1
    )
